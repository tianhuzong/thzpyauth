...
cpdef str sendemail(str smtp,int port,str from_email,str password,str to,str subject,str content):
    """
    发送邮件
...
cdef class Emailer:
    ...
    cdef str from_email
    cdef object con
    def __cinit__(self,str smtp,int port,str from_email,str password):
        """
        :param smtp:str smtp服务器,例如smtp.qq.com
        :param port:int 端口
        :param from:str 邮箱地址
